...
from grading.grading import GradeResult
from grading.grading import run_with_timeout
from grading.grading import IncorrectOutput
    ...
    try:
        ...
        def timeoutwrapper_analysis():
            student_rv = analysis.assess_portfolio(\
                    ...
                    gen_plot=False)
            return student_rv
        # result = run_with_timeout(timeoutwrapper_analysis,max_seconds_per_call,(),{},timeout_manager)
        result = timeoutwrapper_analysis()
        student_cr = result[0]
